...
#SBATCH --array=0-5 ## number of jobs to run "in parallel" 384
...
#SBATCH --mem-per-cpu=32G ## how much RAM do you need per CPU (this effects your FairShare score so be careful to not ask for more than you need))
