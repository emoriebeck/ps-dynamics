...
#SBATCH --array=0-9953 ## number of jobs to run "in parallel" 10427
...
#SBATCH --job-name="q1-idio_\${SLURM_ARRAY_TASK_ID}" ## use the task id in the name of the job
#SBATCH --output=q1-idio.%A_%a.out ## use the jobid (A) and the specific job index (a) to name your log file
